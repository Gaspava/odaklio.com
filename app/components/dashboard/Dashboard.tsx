    ...
    >
      ...
      {isMobile && activePage === "focus" && (
        <button
          ...
          className="fixed z-50 flex items-center justify-center w-12 h-12 rounded-full active:scale-95 transition-all"
          style={{ bottom: 72, right: 16, background: "#ffffff", boxShadow: "0 4px 20px rgba(0,0,0,0.15)", color: "#1e293b" }}>
